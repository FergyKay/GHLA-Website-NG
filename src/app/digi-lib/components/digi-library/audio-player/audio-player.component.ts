    ...
    if (supportsAudio) {
        var index = 0,
            ...
            buildPlaylist = $.each(tracks, function(key, value) {
                ...
                $('#plList').append('<li class="list-group-item"><span class="plTitle">' + trackName + '</span>  <span class="plLength">' + trackLength + '</span></span></li>');
                // $('#plList').append('<li style="li:nth-child(even) {background: #CCC}; li:nth-child(odd) {background: #FFF};" class="list-group-item"><span class="plItem"><span class="plNum">' + trackNumber + '.</span><span class="plTitle">' + trackName + '</span><span class="plLength">' + trackLength + '</span></span></li>');
            }),
